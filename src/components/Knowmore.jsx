...
const Knowmore = () => {
    return (
        <div className=" bg-black flex justify-center lg:h-72 lg:px-48  sm:py-20 sm:px-20 xs:pt-10 sm:pt-10 xs:px-14 md:px-36  ">
            <div className="bg-gray-700 text-white text-center lg:h-72 lg:px-10 bg-cover bg-opacity-80 bg-center "  style={{ backgroundImage: 'url(https://wallpaperaccess.com/full/13672.jpg)',opacity: '1',
